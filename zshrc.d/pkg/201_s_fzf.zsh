...
pkg_init() {
    ...
    export FZF_DEFAULT_OPTS="--height 75% --multi --reverse --margin=0,1 --bind ctrl-f:page-down,ctrl-b:page-up,ctrl-/:toggle-preview --bind pgdn:preview-page-down,pgup:preview-page-up --preview 'bat --line-range :100 {}' --marker='✚' --pointer='▶' --prompt='❯ ' --no-separator --scrollbar='█' --color bg+:#262626,fg+:#fdada,hl:#f09479,hl+:#f09479 --color border:#303030,info:#cfcfb0,header:#80a0ff,spinner:#36c692 --color prompt:#87afff,pointer:#ff5189,marker:#f09479"
